...
type Tab = 'templates' | 'builder' | 'sites' | 'leads' | 'embed' | 'pipeline' | 'direct_mail'
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-500 mt-1">Create landing pages, manage leads, and run direct mail campaigns</p>
      </div>
      ...
      {/* ── Leads Pipeline Tab ── */}
      {activeTab === 'pipeline' && <LeadsPipelineTab />}

      {/* ── Direct Mail Tab ── */}
      {activeTab === 'direct_mail' && <DirectMailTab />}
