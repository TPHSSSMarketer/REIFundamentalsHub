  ...
  return (
    <div className="h-full">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-xl font-bold text-slate-800">Contact Details</h1>
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6 h-[calc(100%-3.5rem)]">
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
            ...
            <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t border-slate-100">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-green-50 text-green-700 rounded-lg hover:bg-green-100 transition-colors"
              >
                <MessageSquare className="w-3.5 h-3.5" /> SMS
              </button>
              <button
                onClick={() => navigate('/documents')}
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-orange-50 text-orange-700 rounded-lg hover:bg-orange-100 transition-colors"
              >
                <FileText className="w-3.5 h-3.5" /> Generate Contract
              </button>
              <button
                onClick={() => setShowPofModal(true)}
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-teal-50 text-teal-700 rounded-lg hover:bg-teal-100 transition-colors"
              >
                <Shield className="w-3.5 h-3.5" /> Request POF
              </button>
              <button
        ...
        <div className="w-full lg:w-3/5 flex flex-col min-h-0">
          {/* Tabs */}
          <div className="sticky top-0 z-10 bg-white border border-slate-200 rounded-t-xl flex overflow-x-auto">
