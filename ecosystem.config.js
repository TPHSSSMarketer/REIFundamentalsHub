...
module.exports = {
  apps: [
    ...
    },
    {
      name: "smart-checkins",
      script: "python",
      args: "-c \"import asyncio; from helm.checkins.scheduler import checkin_scheduler; asyncio.run(checkin_scheduler.run_cycle())\"",
      cron_restart: "*/30 * * * *",
      autorestart: false,
      watch: false,
      env: { NODE_ENV: "production" },
    ...
    },
    {
      name: "health-monitor",
      script: "python",
      args: "-c \"import asyncio; from helm.reliability.health_check import health_checker; asyncio.run(health_checker.full_check())\"",
      cron_restart: "* * * * *",
      autorestart: false,
      watch: false,
      env: { NODE_ENV: "production" },
